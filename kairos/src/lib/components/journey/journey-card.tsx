...
export function JourneyCard({ journey, onDelete, onToggleActive }: JourneyCardProps) {
        ...
        <div className="flex items-start justify-between mb-3">
          ...
          <div className="relative">
            <button
              ...
              onClick={(e) => {
                e.preventDefault();
                // Toggle dropdown menu - you might want to implement a proper dropdown
              ...
              <div className="py-1">
                ...
                >
                  {journey.active ? (
                    ...
                    <>
                      <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1m4 0h1m-6.4-2.8a4 4 0 115.6 0" />
                      </svg>
                      Mark Active
                    </>
                  )}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-sm w-full mx-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-medium text-gray-900">Delete Journey</h3>
                <p className="text-sm text-gray-500">This action cannot be undone.</p>
              </div>
            </div>
            
            <p className="text-sm text-gray-600 mb-6">
              Are you sure you want to delete "<strong>{journey.name}</strong>"? All associated markers and data will be permanently removed.
            </p>
