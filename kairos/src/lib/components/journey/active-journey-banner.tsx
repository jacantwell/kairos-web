// kairos/src/lib/components/journey/active-journey-banner.tsx
...
export function ActiveJourneyBanner({ journey, isLoading, onViewJourney }: ActiveJourneyBannerProps) {
  ...
  if (isLoading && !journey) {
    return (
      <div className="bg-primary-green-600 text-white rounded-lg overflow-hidden">
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center gap-3 ml-4">
            ...
            <button
              ...
              onClick={() => {
                // This could be used to collapse/expand the banner in the future
