            ...
            <div className="p-4 sm:p-6 space-y-4">
              ...
              >
                <div className="text-center">
                  <div className="mx-auto w-12 h-12 bg-primary-green-100 rounded-full flex items-center justify-center mb-3">
                    <svg
                      className="w-6 h-6 text-primary-green-600"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <p className="text-xs text-gray-500 mb-4">
                    Start planning your next bikepacking adventure
                  </p>
                </div>
              </div>
            </div>
